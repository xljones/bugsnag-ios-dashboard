...
struct ProjectStabilityView: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            StabilityChartView(timelinePointsToRender: stability.timelinePoints,
                           selectedIndex: $selectedIndex)
            KeyValueRow(key: "", value: friendlyDatefromTimestamp(iso8601Timestamp: stability.timelinePoints[selectedIndex].bucketStart))
